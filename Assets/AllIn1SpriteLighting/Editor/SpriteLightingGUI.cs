...
public class SpriteLightingGUI : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        GenericEffect(materialEditor, properties, propertiesStyle, oldKeyWords.Contains("OUTLINE_ON"), "5.Outline", "OUTLINE_ON", 15, 19);
        GenericEffect(materialEditor, properties, propertiesStyle, oldKeyWords.Contains("FADE_ON"), "6.Fade", "FADE_ON", 20, 26);
        GenericEffect(materialEditor, properties, propertiesStyle, oldKeyWords.Contains("HSV_ON"), "7.Hue Shift", "HSV_ON", 27, 29);
        GenericEffect(materialEditor, properties, propertiesStyle, oldKeyWords.Contains("HITEFFECT_ON"), "8.Hit Effect", "HITEFFECT_ON", 30, 32);
        GenericEffect(materialEditor, properties, propertiesStyle, oldKeyWords.Contains("WIND_ON"), "9.Grass Movement / Wind", "WIND_ON", 35, 37);
